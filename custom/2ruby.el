;;; 2ruby.el --- Ruby accommodation
;;; Commentary:
;;; Code:
(require 'enh-ruby-mode)
(setq enh-ruby-program "/users/lfenn/.rvm/rubies/ruby-1.9.3-p448/bin/ruby")
...
(eval-when-compile (require 'cl)) ; If you don't have it already
...
(defun* get-closest-gemfile-root (&optional (file "Gemfile"))
  ...
  (let ((root (expand-file-name "/"))) ; win32
    (loop
